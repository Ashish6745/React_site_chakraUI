...
const MyCarousel = () =>(
    <Carousel autoPlay={true} infiniteLoop={true} interval={1000} showStatus={false} showThumbs={false} showArrows={false}>
        <Box w='full' h="100vh">
            <Image src={img1} />
            <Heading bgColor={"blackAlpha.600"} color={"white"} {...options}>Watch the Latest Videos</Heading>
        </Box>
        <Box w='full' h="100vh">
            <Image src={img2} />
            <Heading bgColor={"whiteAlpha.800"} color={"black"} {...options}>Future Videos</Heading>
        </Box>
        <Box w='full' h="100vh">
            <Image src={img3} />
            <Heading bgColor={"whiteAlpha.600"} color={"black"} {...options}>Gaming Videos</Heading>
        </Box>
        <Box w='full' h="100vh">
            <Image src={img4} />
            <Heading bgColor={"whiteAlpha.600"} color={"black"} {...options}>Future Videos</Heading>
        </Box>
